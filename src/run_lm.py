...
class TextDataset(Dataset):
    def __init__(self, tokenizer: ByteLevelBPETokenizer, args, file_path: str, block_size=512):
    ...
    def __len__(self):
        return len( self.tokenizer.encode_batch(self.examples))
...
def load_and_cache_examples(args, tokenizer, evaluate=False):
    ...
    if args.line_by_line:
        return LineByLineTextDataset(args, file_path=file_path, block_size=args.block_size)
    else:
